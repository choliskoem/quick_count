...
@section('main')
    <div class="main-content">
        <section class="section">
            ...
            <div class="card">
                <form action="{{ route('peserta.update', ['id' => $peserta->id_peserta]) }}" method="POST">
                    @csrf
                    <div class="card-header">
                        <h4>Ubah Data Peserta</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <select class="form-control select2 @error('bagian-pemilu') is-invalid @enderror"
                                ...
                                @foreach ($bagianPemilu as $row)
                                    <option value="{{ $row->id_bagian_pemilu }}"
                                        @if ($row->id_bagian_pemilu == old('bagian-pemilu', $peserta['id_bagian_pemilu'])) selected @endif>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control @error('no-urut') is-invalid @enderror" name="no-urut"
                                value="{{ old('no-urut', $peserta['no_urut']) }}">
                            @error('no-urut')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama-posisi-1') is-invalid @enderror"
                                name="nama-posisi-1" value="{{ old('nama-posisi-1', $peserta->detailPeserta[0]->nama_peserta) }}">
                            @error('nama-posisi-1')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nama-posisi-2') is-invalid @enderror"
                                name="nama-posisi-2" value="{{ old('nama-posisi-2', $peserta->detailPeserta[1]->nama_peserta) }}">
                            @error('nama-posisi-2')
                                <div class="invalid-feedback">
                                    {{ $message }}
                                </div>
